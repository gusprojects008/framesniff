...
''')
   ...
   parsed_frame = L2.IEEE802_11.frames_parser(eapol_msg2)
   store_filter_result, frame_filter_result = L2.IEEE802_11.frames_filter("MACHeader.TypeName == 'Data'", "Body.LLC.Type, MACHeader.BSSID", parsed_frame) 
